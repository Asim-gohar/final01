...
export const blogPages: blogTypes = [
  {
    id: "1",
    slug: "CodeAlpha",
    title: "Exploring the Power of CodeAlpha for Web Development",
    content: "Are you ready to take your web development skills to the next level? Look no further than CodeAlpha - the ultimate toolkit for modern web development. In this blog post, we'll explore how CodeAlpha can supercharge your coding experience and help you build stunning websites with ease.",
    Image: {
      src: '/images/bg alpha.png',
      alt: 'lorem ipsum logo',
      width: 800,
      height: 500, 
    },
    headings: ["1. Efficient Workflow:",
      "2. Versatility:",
    ...
    paragraph: ["With CodeAlpha, you can say goodbye to repetitive tasks and tedious setup processes. Its intuitive interface and powerful features streamline your workflow, allowing you to focus on what matters most - writing clean, efficient code.",
      "Whether you're a beginner or an experienced developer, CodeAlpha offers a wide range of tools and resources to suit your needs. From HTML and CSS to JavaScript and beyond, CodeAlpha has everything you need to bring your ideas to life.",
      " Say goodbye to endless Google searches for the perfect library or plugin. CodeAlpha comes pre-loaded with a curated selection of libraries and frameworks, saving you time and effort during the development process.",
      "With CodeAlpha's built-in responsive design features, creating mobile-friendly websites has never been easier. Whether you're building a simple landing page or a complex web application, CodeAlpha ensures that your site looks great on any device.",
      'Join a thriving community of developers who are passionate about building amazing things with CodeAlpha. Share your projects, ask for help, and collaborate with like-minded individuals who share your passion for web development.',
      "CodeAlpha is constantly evolving to meet the needs of modern web developers. With regular updates and new features added regularly, you can rest assured that you're always working with the latest and greatest tools.",
      " Whether you prefer to work in your favorite code editor or use CodeAlpha's built-in IDE, seamless integration ensures that you can work the way you want, when you want."
    ]
  },
  {
    id: "2",
